      ...
      <nav className="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
            <div className="navbar-nav ms-auto py-0 pr" >
                <Link to='/movers-home'  className="nav-item nav-link ">Home</Link>
                <Link to='/movers-view-orders'  className="nav-item nav-link ">New orders</Link>
                <Link to='/movers-view-rates'  className="nav-item nav-link ">Rates</Link>
                <Link to='/movers-view-complaints'  className="nav-item nav-link ">Complaints</Link>
                <Link to='/movers-profile'  className="nav-item nav-link ">Profile</Link>
                {/* <Link to='' className="nav-item nav-link">Orders</Link>

                    ...
                    <div class="bg-light text-center">
                        ...
                        <div class="text-center p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                ...
                                <h6 class="bi bi-check2 fs-4 text-primary">{value.regno}</h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <span>E-mail </span>
                                <h6 class="bi bi-check2 fs-4 text-primary">{value.email}</h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <span>Contact </span>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-1">
                                <span>Rating </span>
                                <h6 class="bi bi-x fs-4 text-primary">{value.rating ? value.rating.toFixed(1) + "/5" : "N/A"}</h6>
                            </div>
                            {
                                rates.length?rates.map((a)=>{
                                    return(
                                        <>
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <span>Mnimum Charge </span>
                                            <h6 class="bi bi-x fs-4 text-primary">₹ {a.minRate}</h6>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <span>Rate per Kg </span>
                                            <h6 class="bi bi-x fs-4 text-primary">₹ {a.ratePerKg}</h6>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <span>Rate per Km </span>
                                            <h6 class="bi bi-x fs-4 text-primary">₹ {a.ratePerKm}</h6>
                                        </div>
                            </>
                                    )
                                }):''
                            ...
                            <div style={{marginTop:'15px'}} >
                                <button class='btn btn-primary' onClick={()=>{navigate(`/movers-book-packer/${value._id}`)}} >Book now</button>
                            </div>
                        </div>
                    </div>
                </div>
